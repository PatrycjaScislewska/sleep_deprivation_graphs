...
## Details about modifications made to the atlas can be found here: 
Termenon, M., Jaillard, A., Delon-Martin, C., & Achard, S. (2016). Reliability of graph analysis of resting state fMRI using test-retest dataset from the Human Connectome Project. 
NeuroImage, 142, 172–187. https://doi.org/10.1016/j.neuroimage.2016.05.062
